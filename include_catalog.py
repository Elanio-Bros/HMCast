...
def set_files(id_list):
    ...
    for file in files:
        ...
        if len(files_exist)==0:
            Catalog_Files.create(catalog_id=id_list,watched=0,path=file,cutoffs=None)
            # '{"opening":{"time-start":"00:00:00","time-end":"00:00:00"},"completion":{"time-start":"00:00:00","time-end":"00:00:00"}}'

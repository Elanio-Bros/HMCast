...
class Stream_Media(Thread):
            ...
            for id, segment in enumerate(media.segments):
                ...
                if os.path.exists(file):
                    ...
                    if id_seg >= self.files_list:
                        ...
                        # get new uri segment
                        original.media_sequence = int(
                            original.media_sequence)+1
    ...
    def __removing_unused_files(self, original):
        ...
        for file in os.listdir(self.default_path):
            ...
            if os.path.isfile(local_file) and os.path.splitext(file)[1] == '.ts' and "{}_".format(self.resolution) in file and file not in segments:
